...
public class LocacaoServiceTest {
    ...
    public void alugarFilmeTest() {
        ...
        // ========================= EXECUÇÃO ========================= //
        Locacao locacao = this.locacaoService.alugarFilme(this.cliente, this.filme);
    ...
    public void alugarFilmeIndisponivelTest() {
        ...
        // ========================= EXECUÇÃO ========================= //
        Locacao locacao1 = this.locacaoService.alugarFilme(this.cliente, this.filme);
        Locacao locacao2 = this.locacaoService.alugarFilme(this.cliente, this.filme);
